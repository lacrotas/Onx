...
import { FiX } from "react-icons/fi"; // ← используем FiX, как в Delivery

function Contacts({ closeModal }) {
    return (
        <div className="contact_content">
            {/* Кнопка закрытия */}
            <button className="contact-close-btn" onClick={() => closeModal(false)}>
                <FiX size={24} />
            </button>
            ...
            <div className="contact-scrollable">
                <div className="contacts-section">
                    ...
                    <div className="contacts-block">
                        <div className="contact-method">
                            ...
                            <div className="contact-info">
                                ...
                                <a href="tel:+375336779260" className="common_reg">
                                    +375 (33) 677-92-60
                                </a>
                                <a href="tel:+375291201190" className="common_reg">
                                    +375 (29) 120-11-90
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="social-links">
                        <a href="https://t.me/..." className="social-link tg" target="_blank" rel="noreferrer">
                            <FaTelegram size={24} />
                        </a>
                        <a href="https://vk.com/..." className="social-link vk" target="_blank" rel="noreferrer">
                            <FaVk size={24} />
                        </a>
                        <a href="https://instagram.com/..." className="social-link inst" target="_blank" rel="noreferrer">
                            <FaInstagram size={24} />
                        </a>
                        <a href="viber://..." className="social-link viber" target="_blank" rel="noreferrer">
                            <SiViber size={24} />
                        </a>
                    </div>
                </div>
